...
if(!function_exists('current_fiscal_years')) {

	function current_fiscal_years() {
...
if(!function_exists('current_fiscal_year_details')) {

	function current_fiscal_year_details() {

		$CI =& get_instance();

		//$CI->db->where('is_current', 1);

		$year = $CI->db->get('fiscal_year_end_date');
...
if(!function_exists('recently_closed_fy')) {

	function recently_closed_fy() {
		$CI =& get_instance();
		$CI->db->order_by('id','DESC');
		$CI->db->where('is_closed', 'closed');
		$year = $CI->db->get('fiscal_year');
		$query =  $year->row_array();
		return $query['year'];
	}
