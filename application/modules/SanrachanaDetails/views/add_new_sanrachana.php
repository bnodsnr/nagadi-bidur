                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="sanrachana_ground_lenth" value="" class=" form-control decimal_field" id="length">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="sanrachana_ground_width" value="" class=" form-control decimal_field" id="width">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="sanrachana_ground_area_sqft" value="" class=" form-control" id="area_sqft">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>संरचनाको क्षेत्रफल जम्मा वर्गफुट<span style="color:red">*</span></label>
                        <input type="text" name="sanrachana_ground_housing_area_sqft" value="" class=" form-control" id="area_sqft_g" readonly="readonly">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="sanrachana_khud_amount" value="" class=" form-control khud_rate" readonly>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>प्लिन्थलेभलको क्षेत्रफल(रोपनी )<span style="color:red">*</span></label>
                        <input type="text" name="sanrachana_ground_area_ropani" value="" class=" form-control" id="area_sqft_ropani" readonly="readonly">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>संरचनाले चर्चेकाे जग्गाको कर लाग्ने मुल्य<span style="color:red">*</span></label>
      ...
      $(document).ready(function() {
        ...
        $(document).on('input', '#length, #width', function() {
          ...
          if (total_land_area > total_sanrachana_cover_area) {
            ...
            // चर्चेकाे बाहेक जग्गाको भूमिकर मूल्याङ्कन
