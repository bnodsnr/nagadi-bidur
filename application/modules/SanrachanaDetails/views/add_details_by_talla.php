    ...
    <section id="main-content">
        <section class="wrapper site-min-height">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form action="<?php echo base_url() ?>SanrachanaDetails/SaveNew" method="post" class="save_post">
                                ...
                                <div class="row">
                                            ...
                                            <select name="k_no" class="from-control dd_select" id="k_no">
                                                ...
                                                if (!empty($landDescription)) :
                                                    foreach ($landDescription as $key => $ld) : ?>
                                                        <option id="<?php echo  $ld['k_number'] . '_' . $ld['road_name'] . '_' . $ld['nn_number'] ?>" value="<?php echo  $ld['k_number'] ?>"><?php echo  $ld['k_number'] . ' (' . $ld['setting_road_name'] . ')' ?>
                                                        </option>
                                                <?php endforeach;
                                                endif; ?>
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="toal_land_area" value="" class=" form-control" id="land_area_ropani" readonly="readonly">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_land_area_sqft" value="" class=" form-control" id="land_area_sqft" readonly="readonly">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_land_min_amount" value="" class=" form-control total_land_amount" readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_land_tax_amount" value="" class=" form-control total_land_tax_amount" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sanrachana_n_no" class="form-control" id="n_no" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sanrachana_min_amount" value="" class=" form-control structure_min_amount" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label> संरचनाको कवोल मुल्य(प्र व.फु.) <span style="color:red">*</span></label>
                                            <input type="text" name="sanrachana_kubul_amount" value="" class=" form-control min_fixed_rate">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <label>तल्ला छान्नुहोस्<span style="color:red">*</span></label>
                                                        <input type="text" name = "sanrachana_floor[]" class="form-control floor" value = "1" id="floor_1" readonly>
                                                    </td>

                                                    <td>
                                                        <div class="form-group">
                                                            <label>क्षेत्रफल वर्गफुट<span style="color:red">*</span></label>
                                                            <input type="text" name="sanrachana_ground_area_sqft_by_floor[]" value="" class=" form-control area_sqft" id="area_sqft_1">
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="sanrachana_khud_amount_by_floor[]" value="" class=" form-control khud_rate" id="khud_1" readonly>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-danger btn-shadow mt-4" data-id = "'+trOneNew+'" style="margin-left:2px;" disabled><i class="fa fa-minus-circle"></i> </button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sanrachan_total_floor" value="1" class=" form-control sanrachan_total_floor" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>संरचनाको खुद कायम मुल्य <span style="color:red">*</span></label>
                                            <input type="text" name="sanrachana_khud_amount" value="" class=" form-control sanrachan_khud_amount" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="charcheko_area" value="" class="form-control charcheko_area" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sanrachana_land_tax_amount" value="" class="form-control sanrachna_ck_land" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sanrachana_dep_rate" value="" class=" form-control dep_rate" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label> सम्पति मूल्याङ्कन जम्मा मुल्य <span style="color:red">*</span></label>
                                            <input type="text" name="net_tax_amount" value="" class=" form-control net_total_amount" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="text" name="bhumi_kar_area" value="" class=" form-control bhumi_kar_area" readonly>
                                                    <span>(वर्गफुट)</span>
                                                </div>
                                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bhumi_kar_amount" value="" class=" form-control bhumi_kar_amount" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class=" col-md-12 warning" id="warning">
                                     <div class="alert alert-danger">संरचनाले चर्चेकाे जग्गाको क्षेत्रफल जग्गाको क्षेत्रफ़ल भन्दा बढी भएको हुनाले भुमि कर नलाग्ने!!!</div>
                                    </div>
                                </div>
                                <!--row-->
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '.btnAddNew' ,function(e){
                ...
                '<td><input type="text" name = "sanrachana_floor[]" class="form-control floor" value = "" id="floor_'+trOneNew+'" readonly></td>'+
                ...
                '<td><div class="form-group"><input type="text" name="sanrachana_ground_area_sqft_by_floor[]" value="" class=" form-control area_sqft" id="area_sqft_'+trOneNew+'"></div></td>'+

                '<td><div class="form-group"><input type="text" name="sanrachana_khud_amount_by_floor[]" value="" class=" form-control khud_rate" id="khud_'+trOneNew+'" readonly></div></td>'+
