                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input type="hidden" name="ls_file_no"
                                            value="<?php echo $lo_details['file_no']?>" id="file_no">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sanrachana_ground_width" value="<?php echo $row['sanrachana_ground_width']?>" class=" form-control decimal_field"
                                            id="width">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="charcheko_area" value="<?php echo $row['sanrachana_ground_housing_area_sqft']?>"
...
<script type="text/javascript" src="<?php echo base_url()?>assets/assets/select2/js/select2.min.js"></script>
                ...
                $(document).ready(function() {
                    ...
                    $(document).on('change', '#k_no', function() {
                      ...
                      $.ajax({
                       ...
                       data: {
                            k_no: k_no[0], road_name: k_no[1], nn_number: k_no[2], file_no:file_no,
                           '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'
                       },
                       success: function(resp) {
                        if (resp.status == 'success') {
                            if (resp.data == null) {
                                $("#land_area_ropani").val('');
                                $("#total_land_tax_amount").val('');
                        ...
                        var w = $('#width').val();
                        var total_value = l * w;
                        calculateFieldsValue(total_value);
                      }
                  }
              });
                  });
        ...
        $(document).on('input', '#area_sqft', function() {
            ...
            // प्लिन्थलेभलको संरचनाको लम्बाई / चौडाई
            $('#length').val('');
            $('#width').val('');
            calculateFieldsValue(total_value);
        });
        ...
        function calculateFieldsValue(total_value) {
