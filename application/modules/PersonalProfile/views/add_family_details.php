...
<section id="main-content">
  <section class="wrapper site-min-height">
    ...
    <div class="row">
      <div class="col-sm-12">
        <form action ="<?php echo base_url()?>PersonalProfile/saveFamilyDetails" method="post" class="save_post">
                  ...
                  <div class="row">
                    <table class="table table-bordered" id="add_new_fields">
                      ...
                      <tr class="productPurchaseFields" id="partsPurchaseFields_1" data-id="1">
                          ...
                          <td>
                            <button type="button" class="btn btn-flat btn-danger"><i class="fa fa-trash-o"></i> हटाउनुहोस</button>
                          </td>
                        </tr>
                        <tfoot>
                          <tr>
                            <td colspan="6"><button  type="button" class="btn btn-warning btn-block btnAddNew"><i class="fa fa-plus-circle"></i> नया सदस्य थप्नुहोस</button></td>
                          </tr>
                        </tfoot>
                      </tbody>
                    </table>
