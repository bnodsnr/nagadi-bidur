...
<section id="main-content">
  <section class="wrapper site-min-height">
    ...
    <div class="row">
      <div class="col-sm-12">
        <form action="<?php echo base_url() ?>PersonalProfile/saveTransferProfile" method="post" class="save_post">
            ...
            <div class="col-md-12">
              <section class="card">
                <header class="card-header" style="background: #1b5693;color:#FFF">
                  ...
                  <br>नाम: <?php echo $profile_details['land_owner_name_np'] ?> (<?php echo $profile_details['file_no'] ?>)
                  <input type="hidden" name="form_filler_date" class="form-control" value="<?php echo convertDate(date('Y-m-d')) ?>" readonly>
                ...
                <input type="hidden" name="old_file_no" value="<?php echo !empty($profile_details['file_no']) ? $profile_details['file_no'] : ''; ?>">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-2">
                        ...
                        <div class="">
                          <select class="form-control" name="fiscal_year" required>
                            ...
                            <?php foreach ($fiscal_year as  $data) : ?>
                              <option value="<?php echo $data['year'] ?>" <?php if ($data['year'] == current_fiscal_year()) {
                                                                            echo 'selected';
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <select name="land_own_type" class="form-control" required>
                          <option value="">छान्नुहोस् </option>
                          <option value="एकल" selected="selected" <?php if ($profile_details['land_own_type'] == 'एकल') {
                                                                    echo 'selected';
                                                                  } ?>>एकल</option>
                          <option value="संयुक्त" <?php if ($profile_details['land_own_type'] != 'एकल') {
                                                    echo 'selected';
                                                  } ?>>संयुक्त</option>
                        </select>
                      </div>
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control citizenship_no" placeholder="" name="lo_czn_no" value="">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control" placeholder="" name="lo_pan_no" id="lo_pan_no" value="">
                        </div>
                      </div>
                    </div>
                        ...
                        <select name="land_owner_occupation" class="form-control dd_select">
                          ...
                          <?php if (!empty($occupation)) :
                            foreach ($occupation as $data) : ?>
                              <option value="<?php echo  $data['name'] ?>" <?php if ($data['name'] == $profile_details['land_owner_occupation']) {
                                                                              echo 'selected';
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select name="land_owner_gender" class="form-control dd_select">
                          <option value="">छान्नुहोस् </option>
                          <option value="पुरुष" <?php if ($profile_details['land_owner_gender'] == 'पुरुष') {
                                                  echo 'selected';
                                                } ?>>पुरुष</option>
                          <option value="महिला" <?php if ($profile_details['land_owner_gender'] == 'महिला') {
                                                  echo 'selected';
                                                } ?>>महिला</option>
                          <option value="अन्य" <?php if ($profile_details['land_owner_gender'] == "अन्य") {
                                                  echo 'selected';
                                                } ?>>अन्य</option>
                        </select>
                      </div>
                        ...
                        <select name="nationality" class="form-control dd_select">
                          ...
                          <?php if (!empty($nationality)) :
                            foreach ($nationality as $key => $n) : ?>
                              <option value="<?php echo $n['name'] ?>" <?php if ($profile_details['nationality'] == $n['name']) {
                                                                          echo 'selected';
                        ...
                        <select class="form-control dd_select npl_state" name="lo_province" required id="province">
                          ...
                          <?php if (!empty($provinces)) :
                            foreach ($provinces as $key => $p) : ?>
                              <option value="<?php echo $p['ID'] ?>" <?php if ($p['ID'] == $profile_details['lo_state']) {
                                                                        echo 'selected';
                        ...
                        <select class="form-control dd_select npl_districts" id="district" required name="lo_district_id">
                          ...
                          <?php if (!empty($districts)) :
                            foreach ($districts as $d) : ?>
                              <option value="<?php echo $d['id'] ?>" <?php if ($d['id'] == $profile_details['lo_district']) {
                                                                        echo 'selected';
                        ...
                        <select class="form-control npl_gapana dd_select lo_gapanapa" name="lo_gapanapa" id="metro" required>
                          ...
                          if (!empty($gapana)) :
                            foreach ($gapana as $key => $gp) : ?>
                              <option value="<?php echo $gp['id'] ?>" <?php if ($gp['id'] == $profile_details['lo_gapa_napa']) {
                                                                        echo 'selected';
                        ...
                        <select name="lo_address_ward" class="form-control p_address_ward dd_select " id="address_ward" required>
                          ...
                          <?php if (!empty($ward)) :
                            foreach ($ward as $key => $w) : ?>
                              <option value="<?php echo $w['name'] ?>" <?php if ($w['name'] == $profile_details['lo_ward']) {
                                                                          echo 'selected';
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <select name="lo_land_ward" class="form-control dd_select" id="land_ward" required>
                          ...
                          <?php if (!empty($ward)) :
                            foreach ($ward as $key => $w) : ?>
                              <option value="<?php echo $w['name'] ?>" <?php if ($w['name'] == $profile_details['lo_land_lac_ward']) {
                                                                          echo 'selected';
                                                                        } ?>><?php echo 'वडा नं-' . $this->mylibrary->convertedcit($w['name']) ?></option>
                          <?php endforeach;
                          endif; ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select class="form-control dd_select npl_temp_state" name="lo_temp_state" required id="province">
                          ...
                          <?php if (!empty($provinces)) :
                            foreach ($provinces as $key => $p) : ?>
                              <option value="<?php echo $p['ID'] ?>" <?php if ($p['ID'] == $profile_details['lo_temp_state']) {
                                                                        echo 'selected';
                                                                      } ?>><?php echo $p['Title'] ?></option>
                          <?php endforeach;
                          endif; ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select class="form-control dd_select npl_temp_districts" id="lodistrict" required name="lo_temp_district">
                          ...
                          <?php if (!empty($districts)) :
                            foreach ($districts as $d) : ?>
                              <option value="<?php echo $d['id'] ?>" <?php if ($d['id'] == $profile_details['lo_temp_dis']) {
                                                                        echo 'selected';
                                                                      } ?>><?php echo $d['name'] ?></option>
                          <?php endforeach;
                          endif; ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select class="form-control dd_select lo_temp_gapanapa" name="lo_temp_gapanapa" id="metro" required>
                          ...
                          if (!empty($gapana)) :
                            foreach ($gapana as $key => $gp) : ?>
                              <option value="<?php echo $gp['name'] ?>" <?php if ($gp['name'] == $profile_details['lo_temp_gapanapa']) {
                                                                          echo 'selected';
                                                                        } ?>><?php echo $gp['name'] ?></option>
                          <?php endforeach;
                          endif; ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select name="lo_temp_ward" class="form-control dd_select" id="temp_address_ward" required>
                          ...
                          <?php if (!empty($ward)) :
                            foreach ($ward as $key => $w) : ?>
                              <option value="<?php echo $w['name'] ?>" <?php if ($profile_details['lo_temp_ward'] == $w['name']) {
                                                                          echo 'selected';
                                                                        } ?>><?php echo 'वडा नं-' . $this->mylibrary->convertedcit($w['name']) ?></option>
                          <?php endforeach;
                          endif; ?>
                        ...
                        <select name="lo_land_ward" class="form-control dd_select" id="land_ward" required>
                          ...
                          ?>
                              <option value="<?php //echo $w['name']
                                              ?>"><?php //echo 'वडा नं-'.$this->mylibrary->convertedcit($w['name'])
                                                  ?></option>
                                ...
                                <select name="family_member_relation[]" class="form-control dd_select" id="relation_1" required>
                                  ...
                                  <?php if (!empty($rel)) :
                                    foreach ($rel as $key => $re) : ?>
                                      <option value="<?php echo $re['name'] ?>" <?php if ($fd['member_relation'] == $re['name']) {
                                                                                  echo 'selected';
                                                                                } ?>><?php echo $this->mylibrary->convertedcit($re['name']) ?></option>
                                  <?php endforeach;
                                  endif; ?>
                                </select>
                              </td>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select class="form-control bi_state dd_select" name="form_filler_state" required id="">
                          ...
                          <?php if (!empty($provinces)) :
                            foreach ($provinces as $key => $p) : ?>
                              <option value="<?php echo $p['ID'] ?>" <?php if ($p['ID'] == $profile_details['lo_fi_state']) {
                                                                        echo 'selected';
                                                                      } ?>><?php echo $p['Title'] ?></option>
                          <?php endforeach;
                          endif; ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select class="form-control bi_districts dd_select" id="district_selected" required name="form_filler_district">
                          ...
                          <?php if (!empty($districts)) :
                            foreach ($districts as $d) : ?>
                              <option value="<?php echo $d['id'] ?>" <?php if ($d['id'] == $profile_details['lo_fi_district']) {
                                                                        echo 'selected';
                                                                      } ?>><?php echo $d['name'] ?></option>
                          <?php endforeach;
                          endif; ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select class="form-control bi_gapana dd_select" name="form_filler_vdc_municipality_id" id="metro" required>
                          ...
                          if (!empty($gapana)) :
                            foreach ($gapana as $key => $gp) : ?>
                              <option value="<?php echo $gp['id'] ?>" <?php if ($d['id'] == $profile_details['lo_fi_gapa_napa']) {
                                                                        echo 'selected';
                                                                      } ?>><?php echo $gp['name'] ?></option>
                          <?php endforeach;
                          endif; ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select name="form_filler_ward_no_id" class="form-control dd_select" id="app_ward_no" required>
                          ...
                          <?php if (!empty($ward)) :
                            foreach ($ward as $key => $w) : ?>
                              <option value="<?php echo $w['name'] ?>" <?php if ($profile_details['lo_fi_ward'] == $w['name']) {
                                                                          echo 'selected';
                                                                        } ?>><?php echo 'वडा नं-' . $this->mylibrary->convertedcit($w['name']) ?></option>
                          <?php endforeach;
                          endif; ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select name="form_filler_relation" class="form-control" id="app_relation" required>
                          ...
                          <?php if (!empty($rel)) :
                            foreach ($rel as $key => $re) : ?>
                              <option value="<?php echo $re['name'] ?>" <?php if ($profile_details['lo_fi_relation'] == $re['name']) {
                                                                          echo 'selected';
                                                                        } ?>><?php echo $this->mylibrary->convertedcit($re['name']) ?></option>
                          <?php endforeach;
                          endif; ?>
    ...
    $('.btnAddNew').click(function(e) {
      ...
      var new_row =
        ...
        '<select class="form-control dd_select" name="family_member_relation[]" data-placeholder="छान्नुहोस्" id="main_topic' + trOneNew + '" data-id="' + trOneNew + '"><option value="">छान्नुहोस्</option><?php if (!empty($rel)) {
                                                                                                                                                                                                                foreach ($rel as $key => $re) { ?><option value="<?php echo $re['name'] ?>"><?php echo $re['name'];
                                                                                                                                                                                                                                                                                          }
                                                                                                                                                                                                                                                                                        } ?></option></select>' +
