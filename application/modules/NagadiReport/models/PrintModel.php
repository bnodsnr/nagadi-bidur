...

{
  ...
  public function getNagadiTotalByTopic($topic, $ward, $from_date, $to_date, $fiscal_year)
  {
    ...
    if (!empty($fiscal_year) && $fiscal_year != "-") {
  ...
  public function getNagadiTotalByMT($topic, $from_date, $to_date, $fiscal_year)
  {
    // $fiscal_year = $this->input->post('fiscal_year');
    // $from_date = $this->input->post('from_date');
    // $to_date = $this->input->post('to_date');
  ...
  public function getNagadiTotalByWard($ward, $from_date, $to_date, $fiscal_year)
  {
  ...
  public function getSampatiTotalByWard($ward, $from_date, $to_date, $fiscal_year)
  {
