						<div class="table-responsive">
							...
							<thead>
								...
								<tr>
										...
										<td><?php echo !empty($sward_3->total)?$this->mylibrary->convertedcit(number_format($sward_3->total)):$this->mylibrary->convertedcit(0) ?></td>
								...
								<tfoot>
									...
									<tr>
										...
										<td><?php echo $this->mylibrary->convertedcit(number_format($nward_0))?></td>
