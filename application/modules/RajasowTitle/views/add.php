...
<form action="<?php echo base_url()?>RajasowTitle/save" method="post" class="form save_post">
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
  <div class="form-group">
    <div class="col-md-12">
      <div class="form-group">
        <label>आम्दानी शिर्षक<span style="color:red">*</span></label>
        <input type="text" class="form-control" placeholder=""  name="topic_name" value="" required="required">
      </div>

      <div class="form-group">
        <label>शिर्षक नम्बर<span style="color:red">*</span></label>
        <input type="text" class="form-control" placeholder=""  name="topic_id" value="" required="required">
      </div>
      
      <div class="form-group">
        <label>आनुमनित संकलन रकम<span style="color:red">*</span></label>
        <input type="text" class="form-control" placeholder=""  name="annual_income" value="" required="required">
      </div>
