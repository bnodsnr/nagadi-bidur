        ...
        <section class="card">
          <header class="card-header">
            <div class="mail-option">
              ...
              <div class="btn-group hidden-phone">
                <input type="text" class="form-control" id="org_name" placeholder="संस्थाको नाम" style="width: 270px;">
              </div>
              <div class="btn-group hidden-phone">
                <input type="text" class="form-control" id="darta_no" placeholder="संस्थाको दर्ता न">
              </div>
              <div class="btn-group hidden-phone">
                <input type="text" class="form-control" id="contact_no" placeholder="सम्पर्क नं" style="width: 220px;">
              </div>
              <div class="btn-group hidden-phone">
                <div class="">
              ...
              <?php if($this->authlibrary->HasModulePermission('BUSINESS-PROFILE', "ADD")) { ?>
                <div class="float-right position">
                  <a class="btn btn-primary " href="<?php echo base_url()?>BusinessProfile/CreateProfile" style="color:#FFF;margin-top: 2px;"><i class="fa fa-plus"></i> नयाँ थप्नुहोस् </a>
                </div>
              <?php } ?>
            </div>
            </span>
  ...
  $(document).ready(function(){
    ...
    function fetch_all_data(file_no= '', org_name= '',darta_no= '',contact_no =''){
      var oTable = $('#listtable').DataTable({
        ...
        "ajax":{
          "url": "<?php echo base_url('BusinessProfile/GetBusinessProfileList') ?>",
          "dataType": "json",
          "type": "POST",
              ...
              },
              {
                "data": "", render: function ( data, type, row ) {
                    var res ='<div class="btn-group">'+
                                ...
                                <?php if($this->authlibrary->HasModulePermission('BUSINESS-PROFILE','VIEW')) { ?>
                                  res += '<a class="dropdown-item"><i class="fa  fa-hand-o-right"></i> प्रोफाइल हेर्नुहोस</a>';
                                <?php } ?>
                                ...
                                <?php if($this->authlibrary->HasModulePermission('BUSINESS-PROFILE','EDIT')) { ?>
                                  res += '<a class="dropdown-item" href="<?php echo base_url()?>LandDetails/veiwLandDescription/'+row.file_no_en+'"><i class="fa  fa-hand-o-right"></i> जग्गाको विवरण</a>'+
                                      ...
                                      '<a class="dropdown-item" href="<?php echo base_url()?>BusinessProfile/CreateProfile/'+row.id+'"><i class="fa  fa-hand-o-right"></i> विवरण सम्पादन गर्नुहोस्</a>';
                                <?php } ?>
                                <?php if($this->authlibrary->HasModulePermission('BUSINESS-PROFILE', 'DELETE')){ ?>
                                  res += '<a class="dropdown-item" href="<?php echo base_url()?>BusinessProfile/veiwSanrachanaDetails/'+row.id+'"><i class="fa  fa-hand-o-right"></i> प्रोफाइल हटाउनुहोस्</a>';
                                <?php } ?>
                          res += '</div"></div>';
