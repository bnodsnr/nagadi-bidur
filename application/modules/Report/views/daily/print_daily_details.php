...
<body style="--bleeding: 0.5cm;--margin: 1cm;">
  ...
  <div class="page">
    ...
    <div style="font-size:10px; margin-left:35px;">आ ब: <?php echo $this->mylibrary->convertedcit(get_current_fiscal_year()) ?></div>
    ...
    <div style="margin-left: 455px;margin-top: 12px;font-size: 22px;"><b>
