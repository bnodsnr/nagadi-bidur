  ...
  <table class="print_table table table-stripe table-bordered">
    ...
    <tbody>
      ...
      if(!empty($nagadi_details)) : 
        ...
        foreach($nagadi_details as $key => $detail) : ?>
          ...
          <td><?php echo $this->mylibrary->convertedcit(round($detail['t_rates'],2))?></td>
    ...
    <table class="table table-bordered">
      ...
      <tr>
        ...
        <td colspan="3"><?php echo !empty($total)? $this->mylibrary->convertedcit(round($total,2)):$this->mylibrary->convertedcit(0)?></td>
      ...
      <tr>
        ...
        <td colspan="3"><?php echo !empty($cancel_amount['cancel_bills'])? $this->mylibrary->convertedcit(round($cancel_amount['cancel_bills'],2)):$this->mylibrary->convertedcit(0)?></td>
