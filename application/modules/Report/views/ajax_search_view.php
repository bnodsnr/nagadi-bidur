 <a href="<?php echo base_url()?>Report/Search/PrintDetails/<?php echo $from_date.'/'.$to_date.'/'.$ward_no.'/'.$user?>" class="btn btn-info" target="_blank"><i class="fa fa-print"></i> प्रिन्ट </a>
        ...
        if(!empty($sampatikar)) :
          ...
          ?>
            <tr>
              ...
              <td><?php echo $this->mylibrary->convertedcit($sampatikar['bhumi_baykeuta_amount'])?></td>
              ...
              <td><?php echo $sampatikar['kname']?></td>
          ...
          <?php endforeach;endif;?>
            <tr>
                <td colspan = "5"></td>
                <td><?php echo $this->mylibrary->convertedcit($ssampati)?></td>
                <td><?php echo $this->mylibrary->convertedcit($sbhumi)?></td>
                <td><?php echo $this->mylibrary->convertedcit($sother_amount)?></td>
                <td><?php echo $this->mylibrary->convertedcit($sfine_amount)?></td>
                <td><?php echo $this->mylibrary->convertedcit($ssampatiba)?></td>
                <td><?php echo $this->mylibrary->convertedcit($sbhumiba)?></td>
                <td><?php echo $this->mylibrary->convertedcit($sdiscount)?></td>
                <td><?php echo $this->mylibrary->convertedcit($sampati_total)?></td>
                <td colspan ='3'></td>
            </tr>
