        ...
        <section class="card">
          ...
          <div class="card-body">
           ...
           <?php if(!empty($nagadi_details)) { ?>
              ...
              <a href="<?php echo base_url()?>Report/MonthlyReport/printNagadiDetailsByTopic/<?php echo $topic_id.'/'.$date.'/'.$ward_no?>" class="btn btn-sm btn-info pull-right"> <i class="fa fa-print"></i> प्रिन्ट गर्नुहोस </a>
