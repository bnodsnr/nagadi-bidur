                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <!--<input type="text" class="form-control" name="pradesh" value="<?php //echo STATENAME?>" readonly="readonly" tabindex="-1">-->
                                     ...
                                     <select class="select_option form-control" name = "ward_no">
                                      <?php if(!empty($wards)) : 
                                        foreach ($wards as $key => $w) : ?>
                                          <option value="<?php echo $w['name']?>" <?php if($this->session->userdata['PRJ_USER_WARD']== $w['name']){ echo 'selected';}?>><?php echo $this->mylibrary->convertedcit($w['name'])?></option>
                                        <?php endforeach;endif;?>
                                    </select>
                                    </div>
                                  </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <table class="table table-bordered" id="add_new_fields">
                          ...
                          <?php else : ?>
                            <tr><td colspan="4"><div class="alert alert-danger">आनुसुचि भेटिएन</div></td></tr>
                          <?php endif;?>
                          </tbody>
                        </table>
                      </div>
