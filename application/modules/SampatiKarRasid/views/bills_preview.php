...
<div style="margin-left: 524px;margin-top:0;font-size: 18px;"><b><?php echo ADDRESS.','.DISTRICT?></b></div>
        ...
        <?php
          ...
          <tr>
             ...
             <!--  <td><?php //echo $value['land_area_type']?></td> -->
              ...
              <td colspan="4"><div class="alert alert-danger">संरचना छैन </div></td>
      ...
      <div style="width: 100%;margin-left:690px; margin-top: 11px;">
          ...
          <table >
            ...
            <tr>
              <td><b>सम्पतिमा बक्यौता (आ.व.)</b></td><td align="right" style="width:150px;"> <?php echo !empty($kar_details['sampati_baykeuta_date'])?$this->mylibrary->convertedcit($kar_details['sampati_baykeuta_date']):$this->mylibrary->convertedcit('-')?></td>
            </tr>
            ...
            <tr>
              <td><b>भूमिमा बक्यौता (आ.व.)</b></td><td align="right" style="width:150px;"> <?php echo !empty($kar_details['bhumi_bakeuta_date'])?$this->mylibrary->convertedcit($kar_details['bhumi_bakeuta_date']):$this->mylibrary->convertedcit('-')?></td>
            </tr>
            <tr>
    ...
    margin-top: 139px;"><b><u>कृपयाः अर्को पटक कर तिर्न आउँदा यो रसिद साथमा लिएर आउनुहोला ।
