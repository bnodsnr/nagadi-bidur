...
<div style="margin-left: 524px;margin-top:0;font-size: 18px;"><b><?php echo ADDRESS.','.DISTRICT?></b></div>
      ...
      <div style="width: 100%;margin-left:690px; margin-top: 11px;">
          ...
          <table >
            ...
            <tr>
              <td><b>सम्पतिमा बक्यौता (आ.व.)</b></td><td align="right"> <?php echo !empty($kar_details['sampati_bakeyuta_date'])?$this->mylibrary->convertedcit($kar_details['sampati_bakeyuta_date']):'-'?></td>
            </tr>
