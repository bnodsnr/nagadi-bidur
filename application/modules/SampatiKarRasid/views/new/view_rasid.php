                ...
                <div class="tab-content tasi-tab" id="myTabContent">
                  <div class="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="home-tab">
                   <div class="page">
                    ...
                    <div style="margin-left: 500px;margin-top: 12px;font-size: 18px;"><b><?php  if($this->session->userdata('PRJ_USER_ID') == 1){echo SLOGAN;} else{echo $this->mylibrary->convertedcit($this->session->userdata('PRJ_USER_WARD')).' नं. वडा कार्यलय';}?></b></div>
                   ...
                   <br>
                      ...
                      <tbody>
                        <?php 
                          if(current_fiscal_year() == recently_closed_fy()) {
                            ...
                            $Billsdetails          = $this->SampatiKarRasidModel->getCurrentPrintPreview($bill_value['bill_no'], $bill_value['nb_file_no']);
                          }
                        ?>
                       <?php
                    ...
                    <div style="width: 100%;margin-left: 795px; margin-top: 11px;">
                      <table style="border: 1px solid #000;">
                        ...
                        <!--</tr>--> 
                        <tr>
                          <td><b>सम्पतिमा बक्यौता रकम रु:</b></td><td align="right"> <?php echo !empty($billing_details_amount['bakeyuta_amount'])?$this->mylibrary->convertedcit(number_format($kar_details['bakeyuta_amount'])).'/-':$this->mylibrary->convertedcit(0).'/-'?></td>
                        </tr>
            
                        <tr>
                          <td><b>सम्पतिमा बक्यौता (आ.व.)</b></td><td align="right"> <?php echo !empty($billing_details_amount['sampati_bakeyuta_date'])?$this->mylibrary->convertedcit(number_format($kar_details['sampati_baykeuta_amount'])).'/-':$this->mylibrary->convertedcit('-').'-'?></td>
                        </tr>
            
                        <tr>
                          <td><b>भूमिमा  बक्यौता रकम रु:</b></td><td align="right"> <?php echo !empty($billing_details_amount['bhumi_baykeuta_amount'])?$this->mylibrary->convertedcit(number_format($kar_details['bhumi_baykeuta_amount'])).'/-':$this->mylibrary->convertedcit(0).'/-'?></td>
                        </tr>
            
                        <tr>
                          <td><b>भूमिमा बक्यौता (आ.व.)</b></td><td align="right"> <?php echo !empty($billing_details_amount['bhumi_bakeuta_date'])?$this->mylibrary->convertedcit($kar_details['bhumi_bakeuta_date']):$this->mylibrary->convertedcit('-')?></td>
                        </tr>
                        <tr style="border: 1px solid #000;">
