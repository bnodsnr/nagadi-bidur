                ...
                <table  class=" table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr class="gradeX">
                        ...
                        <td><?php if($value['ward'] == 0){ echo "नगरपालिका";} else{ echo 'वडा नं '.$this->mylibrary->convertedcit($value['ward']);}?>( <?php echo $value['name']?>)</td>
               ...
               <table  class="display table table-bordered table-striped">
                ...
                <tbody>
                  <?php if(!empty($reserved_bills)) :
                    ...
                    <td colspan="4"><div class="alert alert-danger">No reserverd bill found for current fiscal year.
                    </td>
                  <?php  endif; ?>
                </tbody>
                </table>
