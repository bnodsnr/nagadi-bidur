        ...
        <section class="card">
            ...
            <div class="card-body">
              <div class="search_div">
                <div class="chat-room">
                  <h2 class="text-center">शिर्षकगत रिपोर्ट विवरण 
                    ...
                    <a href="<?php echo base_url()?>NagadiTitleWiseReport/printSearchDetails/<?php echo $from_date?>/<?php echo $to_date?>/<?php echo $ward_no?>" class="btn btn-info btn-sm pull-right" title="मासिक शिर्षकगत रिपोर्ट विवरण" alt="मासिक शिर्षकगत रिपोर्ट विवरण" target="_blank"><i class="fa fa-print"></i> प्रिन्ट गर्नुहोस</a>
                  </h2>
                  ...
                  <table class="table table-bordered print_table">
                    ...
                    <tbody>
                     <tr>
                      ...
                      <td><a href="<?php echo base_url()?>NagadiTitleWiseReport/MonthlySampatiBhumiKarDetailsView/<?php echo $from_date?>/<?php echo $to_date?>/<?php echo $ward_no?>" class="btn btn-warning">विवरण हेर्नुहोस्</a></td>
                    </tr>
                      <?php 
                      $total_nagadi = 0;
                      $i= 2;if(!empty($titles)) :
