 ...
 <section id="main-content">
  <section class="wrapper site-min-height">
    ...
    <div class="row">
      <div class="col-sm-12">
        <section class="card">
          <h2 class="text-center"><?php echo $this->mylibrary->convertedcit($billDetails[0]['topicno'].'-'.$billDetails[0]['main_topic'])?> विवरण (<?php echo $this->mylibrary->convertedcit($from_date.' - '.$to_date)?>)</h2>
