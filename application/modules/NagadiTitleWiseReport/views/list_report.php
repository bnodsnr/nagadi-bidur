        ...
        <section class="card">
            ...
            <div class="card-body">
              <div class="search_div">
                <div class="chat-room">
                   <h2 class="text-center"><b> मासिक कर सङ्कलन विवरण रिपोर्ट  महिना: <?php echo getNepaliMonthName(get_current_month())?> </b><a href="<?php echo base_url()?>NagadiTitleWiseReport/printDetails" class="btn btn-sm btn-info pull-right" title="मासिक शिर्षकगत रिपोर्ट विवरण" alt="मासिक शिर्षकगत रिपोर्ट विवरण" target="_blank"><i class="fa fa-print"></i> प्रिन्ट गर्नुहोस</a></b></h2>
                  <table class="table table-bordered print_table">
                    ...
                    <tbody>
                     <tr>
                      ...
                      <td><a href="<?php echo base_url()?>MonthlyReport/MonthlySampatiBhumiKarDetails" class="btn btn-warning">विवरण हेर्नुहोस्</a></td>
                    </tr>
                      <?php 
                      $total_nagadi =0;
                      $i= 2;if(!empty($titles)) :
