...
<body style="--bleeding: 0.5cm;--margin: 1cm;">
 ...
 <h2 class="text-center"><?php echo $this->mylibrary->convertedcit($titles[0]->topic_no).'-'.$titles[0]->topic_name?> रिपोर्ट (<?php if($from_date !='00' && $to_date !='00'){echo $this->mylibrary->convertedcit($from_date).' देखि '.$this->mylibrary->convertedcit($to_date).' सम्म';}?>)</h2>
 </div>
