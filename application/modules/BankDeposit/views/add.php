              ...
              <div class="card-body">
                ...
                <div class="valid_errors"></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                       <label>बैंक भौचर .<span style="color:red">[supported filetype :jpg ,png ,pdf]</span> </label>
                        <div class="">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                         <?php $due_amount = $total_amount - $total_deposit_amt->deposit_amt;?>
                        <label>जम्मा गर्नु पर्ने रकम<span style="color:red">*</span></label>
                        <div class="">
                          <input type="text" name="total_amount" value="<?php echo round($due_amount,2)?>" id="totalamount" class="form-control" required="true" readonly ="true">
                        </div>
                      </div>
                    </div>
